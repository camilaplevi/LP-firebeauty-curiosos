...
export default defineComponent({
  setup() {
    ...
    const subTitleText = ref('Acompanhe os bastidores, veja transformações de verdade e explore os perfis dos profissionais mais criativos do mundo.')
    ...
    const textDescount = ref('Perfis reais de profissionais e suas rotinas com todo seu dia a dia.')
    ...
    const cards = ref([
      ...
      {
        title: 'Transformações, dicas e tendências',
        subtitle: 'Inspire-se com conteúdos do mundo real. Sem filtros, sem promessas falsas.',
        icon: cardIcons.heart
      },
      {
        title: 'Explore, favorite, compartilhe',
        subtitle: 'Salve seus profissionais favoritos, compartilhe com amigos e monte sua própria curadoria de beleza.',
        icon: cardIcons.web
      },
      {
        title: 'Perfis reais de profissionais da beleza',
        subtitle: 'Veja fotos e vídeos autênticos de procedimentos, resultados e bastidores.',
        icon: cardIcons.star
      }
    ])
